...
// Hospital donor directory endpoint
...
export const getAllDonors = async (req, res) => {
  try {
    ...
    // Blood group filter
    if (bloodGroup !== "all") {
      filterConditions.push({ bloodGroup });
    }

    // City filter
    if (city !== "all") {
      filterConditions.push({ 'address.city': { $regex: city, $options: "i" } });
    }
 ...
 * @route POST /api/hospital/donors/:id/contact
 * @access Private (Hospital)
 */
