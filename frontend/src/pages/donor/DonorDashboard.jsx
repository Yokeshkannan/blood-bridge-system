...
const DonorDashboard = () => {
  ...
  useEffect(() => {
    ...
    const handleDonorDataUpdated = () => {
      console.log("🔔 Donor data update event received");
      fetchDashboardData();
    };

    window.addEventListener("donorDataUpdated", handleDonorDataUpdated);
    return () => {
      window.removeEventListener("donorDataUpdated", handleDonorDataUpdated);
    };
  }, []);
